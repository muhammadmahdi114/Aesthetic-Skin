    ...
    return (
        <div className="bg-white overflow-hidden header fixed h-full w-36 flex flex-col justify-start px-2 gap-y-12">
            ...
            <div className="flex flex-col gap-y-24  text-black font-bold  font-cursive ">
                ...
                <button className="p-1 mt-2 hover:text-white hover:bg-[#c5c5c5] hover:shadow-xl hover:translate-y-[-8px] transition-all transform -rotate-90">
                    AI RECOGNITION
                </button>
                <button className="p-1 hover:text-white hover:bg-[#c5c5c5] hover:shadow-md hover:translate-y-[-2px] transition-all transform -rotate-90">
                    BLOG
                </button>
