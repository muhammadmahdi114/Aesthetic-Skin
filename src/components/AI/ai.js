...
const Ai = React.forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} >
      <div className="pl-32">
        <section className="bg-bgai bg-no-repeat overflow-hidden bg-cover text-black w-full h-screen flex flex-col justify-start items-center py-20">
          ...
          <button
            ...
            className="p-2 rounded text-center font-bold border-white mt-40 bg-gray-200 w-60 hover:bg-gray-100 hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1 focus:outline-none focus:shadow-outline"
          >
            Click to Dive IN!
          </button>
        </section>
