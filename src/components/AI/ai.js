    ...
    return (
        <div>
            <section className="bg-slate-200 bg-no-repeat overflow-hidden bg-cover w-full min-h-screen flex flex-col justify-start items-center py-10">
                <h1 className="font-cursive text-6xl text-center text-black font-extrabold">AI RECOGNITION </h1>
                <div className="text-center pl-36 text-xl mx-auto text-black font-bold font-cursive mt-44">
